...
JAVAC = /usr/bin/javac ${FLAGS} --add-exports=java.desktop/sun.awt.image=ALL-UNNAMED

FLAGS = -g -nowarn -cp "libraries/*"
...
sim/app/signalingswarmgame/*.java \
...
# I'v changed 3d to all - don't need 3d in my simulation
jar: all
